...
# from augmentation import GAT
# from test import GAT_NodeWeightEncoder
...
def load_data(args, val_ratio=0.1, test_ratio=0.2):
    ...
    def loadtrainvaltest():
        ...
        for i in range(train_pos.shape[0]):     # drug‘s name --->int
    ...
    data_o = Data(x=x_o, edge_index=edge_index_o.t().contiguous(), edge_type=label_list,y=y_a)
